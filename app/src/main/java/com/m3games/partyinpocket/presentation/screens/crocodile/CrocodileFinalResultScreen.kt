...
@Composable
fun CrocodileFinalResultScreen(
    ...
    val sortedPlayers = state.players.sortedByDescending { it.score }
    ...
    Scaffold(
        ...
        Column(
            ...
            if (winner != null) {
                ...
                Text(
                    text = stringResource(R.string.crocodile_winner_score, winner.score),
            ...
            Text(
                text = stringResource(R.string.final_table),
                style = MaterialTheme.typography.titleLarge
            )
