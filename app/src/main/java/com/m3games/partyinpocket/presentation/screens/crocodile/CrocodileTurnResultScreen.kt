...
fun CrocodileTurnResultScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.crocodile_total_player_score, state.currentPlayer.score),
            ...
            Button(
                ...
                Text(
                    if (buttonEnabled) {
                        stringResource(R.string.crocodile_next_player)
                    } else {
